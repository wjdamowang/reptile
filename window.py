...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        title_img = QPixmap(r"C:\Users\ASUS\Desktop\零基础学python(1)\（code）实例源码\SL\check tickets\img\bg1.png")  # 打开顶部位图
        ...
        palette.setBrush(QPalette.Background, QtGui.QBrush(QtGui.QPixmap(r'C:\Users\ASUS\Desktop\零基础学python(1)\（code）实例源码\SL\check tickets\img\bg2.png')))  # 设置背景图片
        ...
        palette = QPalette()  # 调色板类
        palette.setBrush(QPalette.Background, QtGui.QBrush(QtGui.QPixmap(r'C:\Users\ASUS\Desktop\零基础学python(1)\（code）实例源码\SL\check tickets\img\bg3.png')))  # 设置背景图片
        ...
        train_img = QPixmap(r'C:\Users\ASUS\Desktop\零基础学python(1)\（code）实例源码\SL\check tickets\img\bg4.png')  # 打开火车信息位图
